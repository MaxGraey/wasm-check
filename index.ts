...
const bulkWasm = u16(
  24832, 28019, 1, 0, 1025, 24577, 0, 515, 1, 773, 1, 2561, 269, 11,
  65, 65, 65, 3068, 2816, 2560, 28164, 28001, 613, 259, 0
)
...
const simdWasm = u32(
  0x6D736100, 1, 1610679297, 33751040, 84344833, 6357249,
  17369600, 4259847, 186257917, 1845758464, 40201569, 259
)

const referencesWasm = u8(
  0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 7, 1,
  5, 0, 208, 112, 26, 11, 0, 10, 4, 110, 97, 109, 101, 2, 3, 1, 0, 0
)
