...
const u16a = (...bytes) => u16(1025, 24577, 0, 515, 1, ...bytes);
const u32a = (...bytes) => u32(1610679297, 33751040, ...bytes);
...
const u32b = (...bytes) => u32a(...bytes, 40239360, 259);
...
const tailCallsWasm = u32b(101318657, 301990913, 268438272, 1835101700, 17039717);
const threadsWasm = u8a(5, 4, 1, 3, 1, 1, 10, 7, 1, 5, 0, 254, 3, 0);
const simdWasm = u32b(84344833, 6357249, 17369600, 4259847, 186257917, 1845758464);
